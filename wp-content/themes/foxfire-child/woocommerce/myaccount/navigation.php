...
<nav class="ff-account-nav" aria-label="<?php esc_attr_e( 'Account Navigation', 'foxfire-child' ); ?>">
	...
	<ul class="ff-account-menu">
		...
		foreach ( wc_get_account_menu_items() as $endpoint => $label ) :
			...
			?>
			<li class="ff-account-menu-item <?php echo $is_active ? 'is-active' : ''; ?>">
		...
		<!-- Testing & COA Verification Shortcut -->
		<li class="ff-account-menu-item ff-account-menu-item--coa">
			<a href="<?php echo esc_url( home_url( '/testing-coa/' ) ); ?>" class="ff-account-menu-link">
				<span class="ff-account-menu-icon" aria-hidden="true">
					<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M4 22h16a2 2 0 0 0 2-2V7.5L14.5 2H6a2 2 0 0 0-2 2v4"/><path d="m3 15 2 2 4-4"/></svg>
				</span>
				<span class="ff-account-menu-text"><?php esc_html_e( 'Batch COA Lookup', 'foxfire-child' ); ?></span>
			</a>
		</li>
	</ul>
