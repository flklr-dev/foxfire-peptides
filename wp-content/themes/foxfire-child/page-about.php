...
$hero_portrait = get_stylesheet_directory_uri() . '/assets/images/about-hero-portrait.jpg';
$hero_product  = get_stylesheet_directory_uri() . '/assets/images/about-hero-product.jpg';
$hero_team     = get_stylesheet_directory_uri() . '/assets/images/about-hero-team.jpg';
?>
	...
	<section class="ff-about-hero-section">
		<div class="ff-about-hero-container">
			...
			<header class="ff-about-header">
				<h1 class="ff-about-header__title"><?php esc_html_e( 'Built on Quality, Trust & Community', 'foxfire-child' ); ?></h1>
				<p class="ff-about-header__subtitle">
					<?php esc_html_e( 'Foxfire Peptides is focused on creating a straightforward, transparent experience for research customers. We believe quality products, accessible information, and dependable service are the foundation of lasting relationships.', 'foxfire-child' ); ?>
				</p>
			</header>
				...
				<div class="ff-bento-col ff-bento-col--middle">
					...
					<div class="ff-bento-card ff-bento-card--stat-orange">
						<div class="ff-bento-card__content">
							...
							<h3 class="ff-bento-card__heading"><?php esc_html_e( 'Transparent & Straightforward', 'foxfire-child' ); ?></h3>
				...
				<div class="ff-bento-col ff-bento-col--right">
					...
					<div class="ff-bento-card ff-bento-card--stat-dark">
						<div class="ff-bento-card__content">
							...
							<h3 class="ff-bento-card__heading"><?php esc_html_e( 'Real People Behind Foxfire', 'foxfire-child' ); ?></h3>
			...
			<div class="ff-about-story-row">
				<div class="ff-about-story-col ff-about-story-col--heading">
					<h2 id="about-story-title" class="ff-about-story__heading">
						<?php esc_html_e( 'A More Personal Approach', 'foxfire-child' ); ?>
					</h2>
				</div>
				<div class="ff-about-story-col ff-about-story-col--body">
					<p>
						<?php esc_html_e( 'We want Foxfire to feel different from an anonymous online storefront. Our goal is to make purchasing simple, information easy to find, and communication clear throughout the customer experience.', 'foxfire-child' ); ?>
					</p>
					<p>
						<?php esc_html_e( 'We believe that lasting trust is earned through everyday consistency. By focusing on clear product details, easy access to testing records where available, and responsive support whenever questions arise, we are building a brand researchers can count on for the long haul.', 'foxfire-child' ); ?>
					</p>
				</div>
			</div>
	...
	<section class="ff-about-values-section" aria-labelledby="about-values-title">
		<div class="ff-about-values-container">
			...
			<header class="ff-about-values-header">
				<h2 id="about-values-title" class="ff-about-values-header__title"><?php esc_html_e( 'Our Core Values', 'foxfire-child' ); ?></h2>
				<p class="ff-about-values-header__subtitle">
					<?php esc_html_e( 'Simple standards that guide how we treat our customers, curate our products, and support the community.', 'foxfire-child' ); ?>
				</p>
			</header>
		...
		<div class="ff-about-cta-container">
			<div class="ff-about-cta-box">
				<div class="ff-about-cta-box__text">
					<h2 id="about-cta-title" class="ff-about-cta-box__title"><?php esc_html_e( 'Explore Foxfire Peptides', 'foxfire-child' ); ?></h2>
					<p class="ff-about-cta-box__desc">
						<?php esc_html_e( 'Browse our catalog of research compounds or check out available batch documentation and certificates of analysis.', 'foxfire-child' ); ?>
					</p>
				</div>
